...
/**
 * Invent_Express_Anneau
 *
 * @ORM\Table(name="Invent_Express_Anneau")
 * @ORM\Entity(repositoryClass="UserBundle\Repository\Invent_Express_AnneauRepository")
 */
class Invent_Express_Anneau
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="Type_produit", type="text")
     */
    private $typeProduit;
